...
def menu():
    while True:
        ...
        if opcion == '1':
            os.system('cls')
            Opcion.opcion1(alumnos_l)
            os.system('pause')
        elif opcion == '2':
            os.system('cls')
            Opcion.opcion2(alumnos_l)
            os.system('pause')
        elif opcion == '3':
            os.system('cls')
            Opcion.opcion3(alumnos_l)
            os.system('pause')
        elif opcion == '4':
            os.system('cls')
            Opcion.opcion4(alumnos_l)
            os.system('pause')
        elif opcion == '5':
            os.system('cls')
            Opcion.opcion5(alumnos_l)
            os.system('pause')
        elif opcion == '6':
            os.system('cls')
            Opcion.opcion6(alumnos_l)
            os.system('pause')
        elif opcion == '0':
            break
